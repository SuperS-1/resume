...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
\textbf{The Original Farm E-commerce Site} & \hfill \href{https://some-link.com}{} \\[3.75pt]
\multicolumn{2}{@{}X@{}}{
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
        \item Built a full-stack website to allow farmers to directly sell organic food to customers
        \item Developed using ReactJS, Bootstrap and Material UI
    \end{itemize}
    \end{minipage}
}  \\
\end{tabularx}
